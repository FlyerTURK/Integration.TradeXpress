...
public class CurrencyUnitMarginTests
{
    ...
    {
        var m = new CurrencyUnitMargin(SimpleGuidGenerator.Instance.Create());
    ...
    {
        var m = new CurrencyUnitMargin(SimpleGuidGenerator.Instance.Create(), null, MarginSetting.Passthrough);
        m.MarginOnBuy.ValueEquals(MarginSetting.Passthrough).ShouldBeTrue();
    }
    ...
    public void Ctor_keeps_unit_reference()
    {
        ...
        var m = new CurrencyUnitMargin(unitId);
