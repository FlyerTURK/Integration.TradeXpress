...
public class TradeXpressDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        TradeXpressGlobalFeatureConfigurator.Configure();
        TradeXpressModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TradeXpressDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<TradeXpressResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/TradeXpress");
        ...
        {
            options.MapCodeNamespace("TradeXpress", typeof(TradeXpressResource));
        });
    }
}
