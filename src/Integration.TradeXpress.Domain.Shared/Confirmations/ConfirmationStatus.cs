...
/// <summary>
/// <b>Teyit</b> (organizasyon-içi karşılıklı mirror onayı) yaşam döngüsü. İki iç taraf (kasa↔kasa veya
...
/// <para><b>NOT:</b> Bu "Teyit"tir — işlem-seviyesi mirror onayı. Bakiye/ilişki seviyesindeki denkleştirme
...
public enum ConfirmationStatus : byte
{
    ...
    /// <summary>Beyan edildi — alıcı, KENDİ ELİYLE kendi girişini oluşturdu (sistem mirror'lamaz) ve bu kayıt
    /// gönderenin çıkışıyla MIRROR doğrulandı; gönderenin GELEN'inde teyidi bekleniyor. Postlama YOK.</summary>
    Declared = 1,

    /// <summary>Teyitlendi — gönderen alıcının kaydını teyit etti; iki taraf (gönderen −, alıcı +) atomik
    /// postlandı, kapandı.</summary>
    Confirmed = 2,

    /// <summary>Reddedildi — alıcı kabul etmedi; postlanmış taraf yok, yalnız durum kapanır. (Gönderen teklifi
