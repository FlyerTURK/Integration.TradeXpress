...
/// <summary>
/// EntityProfile'dan UI kimliğini (ikon + çoğul başlık) TEK KAYNAK çözen yardımcılar. Drill
...
{
    /// <summary>Profilin ikon CSS sınıfı (ham; lokalize EDİLMEZ) — DxTabPage.TabIconCssClass / ikon gösteren yerler için.</summary>
