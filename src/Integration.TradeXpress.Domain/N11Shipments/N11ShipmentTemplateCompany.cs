...
/// (<see cref="ExternalId"/>, <c>N11ShipmentCompany</c> kaydının kimliği). Owned tip (JSON kolonu; sorgulanmaz, N11'e yalnız kimlik
...
/// bağı yok) ve canlıdaki beş şablonun hepsinde boştu; kargo gideri artık şablon/tarife üzerinden
...
public class N11ShipmentTemplateCompany
{
    ...
    /// <summary>N11 kargo firmasının kimliği (<c>N11ShipmentCompany.ExternalId</c>). Ad/kısa kod
    /// <c>N11ShipmentCompany</c>'den okunur — burada KOPYALANMAZ (tek kaynak o tablodur).</summary>
