...
///
/// <para><b>Neden var:</b> N11 ürünün her versiyonunu <b>fotoğrafıyla birlikte DELİL olarak</b> saklıyor
/// ("23/07/2026'da şu varyantı şu fiyata satmıştın") ve aynı üründe fotoğraf değiştiği için iki farklı
...
/// çivileyip sonradan değişmişse bunu tespit edilebilir kılar. (Bugünkü DAM'da içerik blob'u zaten
...
public class SalesChannelTrN11ProductPushHistory : CreationAuditedAggregateRoot<Guid>, IMultiTenant, ICompanyOwned
{
    ...
    /// <i>Ayrı tabloya bölünmedi: delil kaydı OKUNUR, sorgulanmaz — normalizasyon burada karmaşıklık katardı.</i></summary>
