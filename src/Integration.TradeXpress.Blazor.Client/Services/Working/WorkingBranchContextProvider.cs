...
/// <summary>
/// <see cref="IBranchContextProvider"/> uygulaması — circuit'teki çalışma ŞUBESİNİ sunucu-ambient
/// <see cref="ICurrentBranch"/>'e taşır (<c>WorkingCompanyContextProvider</c> deseniyle BİREBİR aynı).
