...
public partial class GoodMovementReportPage
{
    ...
    private List<GoodMovementRowDto>? _movementRows;
    ...
    {
        _movementRows = await GoodReportAppService.GetMovementsAsync(_filter);
    }
}
